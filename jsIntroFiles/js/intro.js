...
console.log("SOMEBODY CALL 911, SHAWTY FOUNFD A BAND-AID ON THE DANCEFLOOR, OH WHOA-OH");
...
"<p>I am so SMART! (I know.)</p>"

document.getElementById('column1').innerHTML+="<img src='images/code.jpg'>";

document.getElementById('column1').innerHTML+="<img class='img-fluid' alt='Annoyingly generic stock image'>";
...
document.getElementById('yuckyID').style.color="#80B6F9";
document.getElementById('yuckyID').style.backgroundColor="#0E2549";
document.getElementById('yuckyID').style.fontSize="24pt";
...
document.getElementById('tastyID').innerHTML += "<p>Opponent Health: " +health+"</p>";

//then we will define damage points for each type of weapon
var damage;

//if the weapom is squid, then the damage points is FIFTY.
...
document.getElementById('tastyID').innerHTML += "<p>"+weapon+" have this much damage: "+damage+"<p>";
